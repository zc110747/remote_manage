...
static int pcf8563_read_block( struct i2c_client *client, u8 reg, void *buf, int len)
{
...
static int i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    //1. alloc memory manage the pcf8563.
