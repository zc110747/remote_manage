...
#include "../../../../../usr_code/remote_manage/upper_app/manage_tool/udpclient.h"
...
void CUdpSocketInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CUdpSocketInfo *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject CUdpSocketInfo::staticMetaObject = { {
    ...
    qt_meta_stringdata_CUdpSocketInfo.data,
    qt_meta_data_CUdpSocketInfo,
    qt_static_metacall,
    nullptr,
    nullptr
} };
